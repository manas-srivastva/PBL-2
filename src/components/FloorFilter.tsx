...
const ZoneFilter = ({ active, onChange }: ZoneFilterProps) => (
  <div className="glass-card-elevated p-4 flex flex-col gap-1">
    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.15em] mb-2">
      Zones
    </span>
    <button
      ...
      return (
        ...
        >
          ...
          <div className="flex flex-col items-start">
            ...
            {!isActive && (
              <span className="text-[10px] text-muted-foreground/60 leading-tight">{zone.description}</span>
            )}
          </div>
        </button>
      );
